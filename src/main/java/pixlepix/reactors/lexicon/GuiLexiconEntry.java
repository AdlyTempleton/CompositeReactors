...
import pixlepix.reactors.lexicon.button.GuiButtonBackWithShift;
import pixlepix.reactors.lexicon.button.GuiButtonPage;
    ...
    public void updateScreen() {
        ...
        if (this.page == entry.pages.size() - 1) {
            ...
            if (entry == this.entry) {
                ...
                positionTutorialArrow();
                if (tutorial.isEmpty()) {
                    mc.thePlayer.addChatMessage(new ChatComponentTranslation("reactors.tutorialEnded").setChatStyle(new ChatStyle().setColor(EnumChatFormatting.RED)));
