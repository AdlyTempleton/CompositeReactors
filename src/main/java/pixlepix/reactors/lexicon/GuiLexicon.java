...
import pixlepix.reactors.lexicon.button.GuiButtonBookmark;
import pixlepix.reactors.lexicon.button.GuiButtonCategory;
import pixlepix.reactors.lexicon.button.GuiButtonInvisible;
...
public class GuiLexicon extends GuiScreen {
    ...
    void drawHeader() {
        ...
        fontRendererObj.drawSplitString(String.format(StatCollector.translateToLocal("reactors.gui.lexicon.header")), left + 18, top + 12, 110, 0);
