...
public class BlockRegistry {
    ...
    public void registerClasses() {
        try {
            ...
            for (ClassPath.ClassInfo classInfo : classPath.getTopLevelClassesRecursive("pixlepix.reactors.block")) {
            ...
            for (ClassPath.ClassInfo classInfo : classPath.getTopLevelClassesRecursive("pixlepix.reactors.item")) {
