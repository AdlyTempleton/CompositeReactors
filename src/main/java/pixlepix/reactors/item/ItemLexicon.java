package pixlepix.reactors.item;
...
import pixlepix.reactors.lexicon.CategoryManager;
import pixlepix.reactors.lexicon.ILexiconable;
import pixlepix.reactors.lexicon.LexiconEntry;
import pixlepix.reactors.lexicon.common.core.helper.ItemNBTHelper;
import pixlepix.reactors.registry.CraftingBenchRecipe;
import pixlepix.reactors.registry.ITTinkererItem;
...
public class ItemLexicon extends Item implements ITTinkererItem {
        ...
        if (par2EntityPlayer.isSneaking()) {
            ...
            if (block != null) {
                if (block instanceof ILexiconable) {
                    ...
                    if (entry != null) {
                        CompositeReactors.proxy.setEntryToOpen(entry);
                        CompositeReactors.proxy.setLexiconStack(par1ItemStack);

                        par2EntityPlayer.openGui(CompositeReactors.instance, 0, par3World, 0, 0, 0);
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
        ...
        CompositeReactors.proxy.setLexiconStack(par1ItemStack);
        par3EntityPlayer.openGui(CompositeReactors.instance, 0, par2World, 0, 0, 0);
    ...
    public ThaumicTinkererRecipe getRecipeItem() {
        return new CraftingBenchRecipe(new ItemStack(this), "CB", "  ", 'C', new ItemStack(Items.minecart), 'B', new ItemStack(Items.book));
    }
